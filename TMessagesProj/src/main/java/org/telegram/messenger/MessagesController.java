...
//                    }
    ...
    public static String getRestrictionReason(ArrayList<TLRPC.TL_restrictionReason> reasons) {
        ...
        for (int a = 0, N = reasons.size(); a < N; a++) {
            ...
            if ("all".equals(reason.platform) || !ApplicationLoader.isStandaloneBuild() && !BuildVars.isBetaApp() && "android".equals(reason.platform) && !NekoConfig.ignoreContentRestrictions.Bool()) {
                return reason.text;
            }
        }
        return null;
